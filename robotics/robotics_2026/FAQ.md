...
1. Read the documentation from [ROCm/AMD_Hackathon Repo](https://github.com/andrewgschmidt/AMD_Hackathon/tree/main/robotics/robotics_2026) on how to set up the environment.
2. To store your datasets, models, and training logs, register for your personal Hugging Face and Weights & Biases (W&B) accounts before the Hackathon begins.
...
2. If the video captuer is not stable (shaking)?
    ...
    A: Connect the cameras with different USB port/hub with the PC (laptop or MiniPC) for smooth video capture.
